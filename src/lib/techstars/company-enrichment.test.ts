  ...
  const result = await enrichStandaloneCompany(
    {
      ...
      sourceFounders: [{
        ...
        sourceUrl: "https://techstars.com/content/cohort",
      }],
    },
    {
      fetchHtml: async (url) => ({
...
test("a clearly company-specific official roster country confirms current location", async () => {
  const result = await enrichStandaloneCompany(
    {
      ...
      officialSourceUrl: "https://techstars.com/content/official-cohort",
  ...
  assert.equal(result.locationEvidence[0]?.authority, "techstars_official");
});
  ...
  const result = await enrichStandaloneCompany(
    {
      ...
      sourceFounders: [
        ...
        },
        {
          name: "Alex Example",
          role: "Former Founder",
          sourceUrl: "https://techstars.com/content/update",
        },
      ],
    },
    {
