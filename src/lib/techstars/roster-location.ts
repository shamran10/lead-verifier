...
export type ResolvedTechstarsRosterLocation = {
...
export function resolveTechstarsRosterLocation(
  value: string | null | undefined,
): ResolvedTechstarsRosterLocation | null {
...
export function extractTechstarsRosterLocation(
  value: string | null | undefined,
) {
  ...
  for (const candidate of candidates) {
    const resolvedLocation = resolveTechstarsRosterLocation(candidate);
...
function resolved(
  ...
  iso2: string,
  confidence: number,
  matchedBy: ResolvedTechstarsRosterLocation["matchedBy"],
): ResolvedTechstarsRosterLocation {
