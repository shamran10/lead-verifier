...
export async function writeMassChallengeCompanyWorkbook(
  document: FilteredMassChallengeDocument,
  outputPath: string,
) {
...
function toCompanyRow(company: FilteredMassChallengeCompany) {
  return {
